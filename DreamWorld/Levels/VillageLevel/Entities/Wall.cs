...
namespace DreamWorld.Levels.VillageLevel.Entities
{
    public class Wall : Entity
    {
        ...
        {
            Model = GameScreen.Content.Load<Model>(@"Models\Village\Wall");
            base.LoadContent();
        }
        ...
        protected override void GetPhysicsInformation(out JigLibX.Physics.Body body, out JigLibX.Collision.CollisionSkin skin, out Vector3 centerOfMass)
        {
            ...
            // Primitive:
            box = new JigLibX.Geometry.Box(Vector3.Transform(new Vector3(-82.93386f, 2.612661f, -0.8867867f), Matrix.CreateScale(Scale)),
                Matrix.CreateFromQuaternion(new Quaternion(0f, 0f, 0f, 0.9999999f)),
                Vector3.Transform(new Vector3(219.8993f, 60.99642f, 3.058752f), Matrix.CreateScale(Scale)));
