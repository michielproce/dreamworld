...
namespace DreamWorld.Levels.VillageLevel.Entities
{
    public class Tubes : Entity
    {
        ...
        protected override void GetPhysicsInformation(out JigLibX.Physics.Body body, out JigLibX.Collision.CollisionSkin skin, out Vector3 centerOfMass)
        {
            ...
            // Primitive:
            box = new JigLibX.Geometry.Box(Vector3.Transform(new Vector3(-16.70321f, 8.821623f, -2.429148f), Matrix.CreateScale(Scale)),
                Matrix.CreateFromQuaternion(new Quaternion(0f, 0f, 0f, 0.9999999f)),
                Vector3.Transform(new Vector3(36.03033f, 4.829021f, 4.858296f), Matrix.CreateScale(Scale)));
            ...
            // Primitive:
            box = new JigLibX.Geometry.Box(Vector3.Transform(new Vector3(-20.22982f, 0.1888404f, -2.040402f), Matrix.CreateScale(Scale)),
                Matrix.CreateFromQuaternion(new Quaternion(0f, 0f, 0f, 0.9999999f)),
                Vector3.Transform(new Vector3(43.4621f, 8.271995f, 4.080804f), Matrix.CreateScale(Scale)));
