...
namespace DreamWorld.Levels.VillageLevel.Entities
{
    public class TunnelClosed : Entity
    {
                                                      ...
                                                      out JigLibX.Collision.CollisionSkin skin, out Vector3 centerOfMass)
        {
            ...
            // Primitive:
            box = new JigLibX.Geometry.Box(Vector3.Transform(new Vector3(-32.02539f, -5.637981f, -0.01107788f), Matrix.CreateScale(Scale)),
                Matrix.CreateFromQuaternion(new Quaternion(0f, 0f, 0f, 0.9999999f)),
                Vector3.Transform(new Vector3(63.95015f, 89.99708f, 183.0041f), Matrix.CreateScale(Scale)));
