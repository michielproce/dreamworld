...
//            lines.Add(new CutsceneLine(@"Audio\Voice\Morwir\40 i_am_morwir", "I am Morwir, by the way."));
            lines.Add(new CutsceneLine(@"Audio\Voice\Morwir\41 old_mans_poverty", "The old man sits down in a big brown chair and begins to tell about the poverty in the village."));
            ...
            lines.Add(new CutsceneLine(@"Audio\Voice\Morwir\46 kettle_potion", "This kettle is filled with a potion to transport people to another dimension."));
            ...
            lines.Add(new CutsceneLine(@"Audio\Voice\Morwir\49 tubbles_dreamworld", "Thats why you are here, Tubbles. You need to go in the Dreamworld for me."));
