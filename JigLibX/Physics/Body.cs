...
namespace JigLibX.Physics
{
    ...
    public partial class Body
    {
        ...
        public virtual void EnableBody()
        {
            ...
            if (DreamWorldPhysicsSystem.CurrentPhysicsSystem == null) return;

            bodyEnabled = true;
            DreamWorldPhysicsSystem.CurrentPhysicsSystem.AddBody(this);
        }
...
//            }
//
//            DreamWorldPhysicsSystem physics = DreamWorldPhysicsSystem.CurrentPhysicsSystem;
